...
%
% compared to original function, scaling has been changed to prevent
...
%    % only use variance of samples within lag, not full variance
%   % var_sum(i)=(y(i)-ybar)^2;
%    var_sum(i)=sqrt((y(i)-ybar)^2*(y(i-k)-ybar)^2);
% end
% 
% % Denominator, unscaled variance
% %yvar = (y-ybar)'*(y-ybar)* 1/N ;
